package com.mangobloggerandroid.app.AnimatedButton;
...
public class Utils {
    ...
    public static List<Icon> getIcons() {
        ...
        icons.add(new Icon(R.mipmap.ic_heart_on, R.mipmap.ic_heart_off, IconType.Heart));
        icons.add(new Icon(R.mipmap.ic_bookmark_on, R.mipmap.ic_bookmark_off, IconType.Bookmark));
